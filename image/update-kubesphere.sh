...
KUBESPHERE_INSTALL_PACKAGE="kubesphere-all-advanced-2.0.1"

pushd /tmp
curl -O -k https://kubesphere-installer.pek3b.qingstor.com/stable/${KUBESPHERE_INSTALL_PACKAGE}.tar.gz
